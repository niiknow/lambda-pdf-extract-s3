...
read -r mbx1 mby1 mbx2 mby2 < <(pdfinfo -box $FILE | grep "MediaBox:" | sed 's/[a-zA-Z: ]*\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]/\1 \2 \3 \4/')
read -r cbx1 cby1 cbx2 cby2  < <(pdfinfo -box $FILE | grep "CropBox:" | sed 's/[a-zA-Z: ]*\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]\([0-9\.]\+\)*[ ]/\1 \2 \3 \4/')
